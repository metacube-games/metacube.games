...
>(({ className, children = "Play", secondary = "Metacube", ...props }, ref) => (
  <a
    ...
    className={cn(
      ...
      "transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary",
      "disabled:pointer-events-none disabled:opacity-50",
      "[&_svg]:size-4 [&_svg]:shrink-0",
      "border-primary bg-primary text-black",
      "shadow-[0_0_20px_5px_hsl(var(--primary)/0.4)]",
      "hover:scale-[1.05] hover:shadow-[0_0_30px_8px_hsl(var(--primary)/0.6)]",
      className,
    )}
    {...props}
  >
