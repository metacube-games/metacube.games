...
export function Footer({
  ...
  const holder =
    copyrightHolder ?? `© ${new Date().getFullYear()} Metacube`;
  return (
    <footer
      className={cn(
        "fixed bottom-0 z-40 flex h-15 w-full items-center justify-between bg-black/40 p-3 backdrop-blur-sm",
        className,
      )}
    >
      <div className="text-xs text-muted-foreground sm:text-sm">
        ...
        <span className="block sm:inline">{allRightsReserved}</span>
      </div>
