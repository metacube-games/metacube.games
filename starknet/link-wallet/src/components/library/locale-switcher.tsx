...
/** Locale switcher. Controlled via `locale`/`onLocaleChange`, or self-managed if omitted. */
      ...
      <DropdownMenuContent align="start" className="!min-w-fit">
        {locales.map((l) => (
          ...
          >
            ...
            {/* Rendered on every row (invisible when inactive) so dropdown width stays stable. */}
            <Play
              aria-hidden
              className={cn(
