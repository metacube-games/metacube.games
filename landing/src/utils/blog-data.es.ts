...
// Hearthstone-style rarity border widths.
...
export const nftStatistics = {
  Skin: {
    ...
    legendary: [{ name: "Pelton Flusk", value: 126, percentage: "1.2%" }],
  },
  Cube: {
    common: [
    ...
    legendary: [{ name: "Metacube", value: 39, percentage: "0.3%" }],
  },
  Coin: {
    common: [
    ...
    rare: [{ name: "Green", value: 2095, percentage: "20.9%" }],
    epic: [{ name: "Red", value: 896, percentage: "8.9%" }],
    mythic: [{ name: "Gray", value: 445, percentage: "4.4%" }],
    legendary: [{ name: "Purple", value: 100, percentage: "1.0%" }],
  },
  Background: {
    common: [
    ...
    epic: [{ name: "Yellow", value: 653, percentage: "6.5%" }],
    mythic: [{ name: "Orange", value: 200, percentage: "2.0%" }],
    legendary: [{ name: "Magenta", value: 118, percentage: "1.1%" }],
  },
  Weapon: {
    common: [
    ...
    legendary: [{ name: "Unicorn", value: 145, percentage: "1.4%" }],
  },
};
...
export const blogPosts: Record<string, BlogPost> = {
  "fidelity-week-event": {
    ...
    content: [
      ...
      { type: "heading", content: "Cómo Funcionó" },
      {
        type: "paragraph",
        content:
          "A diferencia de nuestros otros eventos especiales que transforman el juego, la Semana de Fidelidad se centró puramente en recompensar el rendimiento excepcional dentro de las mecánicas de juego estándar. Los jugadores compitieron para lograr las puntuaciones más altas posibles durante la semana especificada, siendo las posiciones de la tabla de clasificación las que determinaron su parte del pozo de premios.",
      },
      ...
      { type: "heading", content: "Puntuación de la Tabla de Clasificación" },
      {
        type: "paragraph",
        content:
          "Al igual que en nuestros otros eventos, las posiciones de la tabla de clasificación se calcularon basándose en tres factores clave:\n• El número de cubos rotos durante el evento\n• El número total de monedas recolectadas\n• Penalizaciones por muertes durante el evento",
      },
      ...
      { type: "heading", content: "Distribución de Premios" },
      {
        type: "paragraph",
        content:
          "El pozo de premios de 1,000 tokens STRK se distribuyó proporcionalmente entre los mejores jugadores de la tabla de clasificación, con jugadores de mayor rango recibiendo porciones más grandes de las recompensas. Esto creó una competencia emocionante donde cada punto importaba en la carrera por las posiciones más altas.",
      },

      {
        type: "paragraph",
        content:
          "La Semana de Fidelidad demostró nuestro compromiso de reconocer y recompensar a los miembros más dedicados de nuestra comunidad. ¡Estate atento a futuros eventos de Semana de Fidelidad y otras oportunidades especiales para ganar recompensas en el universo de Metacube!",
      },
    ],
    relatedPosts: [
  ...
  "special-events-in-metacube": {
    ...
    excerpt:
      "Descubre el emocionante mundo de los eventos especiales de Metacube que transforman el juego y ofrecen recompensas únicas por tiempo limitado, incluyendo tokens STRK.",
    content: [
      {
        type: "heading",
        content: "Presentando los Eventos Especiales de Metacube",
      },
      {
        type: "paragraph",
        content:
          "En Metacube, organizamos regularmente eventos especiales de tiempo limitado que transforman el universo de Metacube de formas inesperadas. Estos eventos proporcionan desafíos únicos, recompensas exclusivas incluyendo tokens STRK, y experiencias memorables que no encontrarás durante el juego normal.",
      },
      ...
      { type: "heading", content: "Aspectos Destacados de los Eventos" },
      {
        type: "paragraph",
        content:
          "Nuestra comunidad ya ha experimentado algunos eventos inolvidables:",
      },
      {
        type: "paragraph",
        content:
          "• **Crypto Rave Pulse**: Un evento innovador donde Pelton Flusk usó altavoces gigantes emitiendo música rave para anular las defensas eléctricas de Metacube.\n• **Monkecube**: Una transformación total donde Metacube se convirtió en Monkecube, presentando aspectos base con temática de monos y un cambio completo de marca (incluso monkecube.com redirigía a metacube.games).",
      },
      ...
      { type: "heading", content: "Recompensas de los Eventos" },
      {
        type: "paragraph",
        content:
          "Hasta ahora, nuestros eventos han recompensado a los jugadores con **Tokens STRK** basados en su posición en la tabla de clasificación. Los eventos futuros pueden incluir otras recompensas como NFTs y aspectos especiales.",
      },
      ...
      { type: "heading", content: "Sistema de Tabla de Clasificación STRK" },
      {
        type: "paragraph",
        content:
          "Durante los eventos, los jugadores compiten en una tabla de clasificación para ganar tokens STRK. Tu posición se determina por tres factores clave:\n• El número de cubos rotos durante el evento\n• El número total de monedas recolectadas\n• Penalizaciones por muertes durante el evento",
      },

      {
        type: "paragraph",
        content:
          "Consulta nuestra cobertura detallada de eventos pasados como **Monkecube** y **Crypto Rave Pulse** para tener una muestra de lo que es posible en el universo de Metacube en constante cambio. Y recuerda: ¡en un juego con una vida útil finita, cada evento especial es verdaderamente una experiencia única en la vida!",
      },
    ],
  ...
  "monkecube-event": {
    ...
    excerpt:
      "Revive el evento Monkecube, cuando todo el Metacube fue renombrado y transformado con aspectos base de temática de monos.",
    content: [
      { type: "heading", content: "La Transformación Monkecube" },
      {
        type: "paragraph",
        content:
          "Durante este evento especial, Metacube experimentó una transformación completa y fue renombrado a **Monkecube**. Esto no fue solo un pequeño cambio cosmético, fue un cambio completo de marca de la experiencia del juego.",
      },
      ...
      { type: "heading", content: "Recompensas del Evento" },
      {
        type: "paragraph",
        content:
          "Los participantes en el evento Monkecube compitieron por **Tokens STRK**, que fueron otorgados basándose en la tabla de clasificación del evento. La tabla de clasificación rastreó el número de cubos rotos, monedas recolectadas, y aplicó penalizaciones por las muertes de los jugadores.",
      },
      ...
      { type: "heading", content: "Reacciones de la Comunidad" },
      {
        type: "paragraph",
        content:
          "El evento Monkecube rápidamente se convirtió en un favorito de los fans, con la comunidad abrazando la inesperada transformación primitiva. La naturaleza alegre de Monkecube proporcionó un refrescante cambio de ritmo de la experiencia habitual de Metacube.",
      },

      {
        type: "paragraph",
        content:
          "¿Participaste en el evento Monkecube? ¡Comparte tus recuerdos en nuestro canal de Discord o en los comentarios abajo!",
      },
    ],
  ...
  "crypto-rave-pulse-event": {
    ...
    excerpt:
      "Experimenta el evento Crypto Rave Pulse, donde Pelton Flusk usó sistemas de sonido masivos y música rave para anular las defensas eléctricas del Metacube.",
    content: [
      { type: "heading", content: "Sonido vs. Defensas Eléctricas" },
      {
        type: "paragraph",
        content:
          "El Crypto Rave Pulse fue un evento revolucionario en el universo de Metacube. Durante este periodo, Pelton Flusk desplegó altavoces gigantes alrededor del perímetro del Metacube, emitiendo poderosa música rave específicamente calibrada para anular los sistemas de defensa eléctrica del Cubo.",
      },
      ...
      { type: "heading", content: "Impacto en el Juego" },
      {
        type: "paragraph",
        content:
          "Normalmente, las defensas del Metacube causan daño a los jugadores que interactúan con ellas, aunque no impiden el movimiento. Durante el evento Crypto Rave Pulse, estas defensas fueron neutralizadas por la música, permitiendo a los jugadores navegar sin recibir daño de los mecanismos de defensa del cubo.",
      },
      ...
      { type: "heading", content: "Banda Sonora del Evento" },
      {
        type: "paragraph",
        content:
          "La banda sonora completa de Crypto Rave Pulse, compuesta por el propio Pelton Flusk, está disponible en SoundCloud. Puedes escuchar todas las pistas de este evento especial en: [Crypto Rave Pulse by Pelton Flusk](https://soundcloud.com/metacubegames/sets/crypto-rave-pulse-by-pelton-flusk).",
      },
      ...
      { type: "heading", content: "Recompensas del Evento" },
      {
        type: "paragraph",
        content:
          "Los jugadores que participaron en el evento Crypto Rave Pulse compitieron por **Tokens STRK** basándose en su posición en la tabla de clasificación. La clasificación se calculó a partir del número de cubos rotos y monedas recolectadas, con penalizaciones aplicadas por muertes durante el evento.",
      },

      {
        type: "paragraph",
        content:
          "El Crypto Rave Pulse demostró cómo Metacube evoluciona continuamente a través de eventos creativos de tiempo limitado que ofrecen tanto entretenimiento como recompensas valiosas.",
      },
    ],
  ...
  "metacube-gameplay-guide": {
    ...
    excerpt:
      "Sumérgete en las emocionantes mecánicas de juego de Metacube, aprende sobre la misteriosa estructura de Metacube, la moneda del juego y supera desafíos peligrosos en esta guía completa.",
    content: [
      { type: "heading", content: "Introducción a Metacube" },
      {
        type: "paragraph",
        content:
          "Metacube es un revolucionario juego NFT gratuito que combina la emoción de la búsqueda de tesoros, el intriga de la tecnología blockchain y la emoción de la exploración interestelar. En esta inmersiva experiencia de juego, los jugadores asumen el papel de Stove the Crypto Raver, un fanático acérrimo de las criptomonedas y asiduo de las raves interestelares. Junto con otros Stellar Scavengers, los jugadores se embarcan en una atrevida misión para desbloquear los secretos del Metacube, una bóveda celestial que contiene valiosos datos de blockchain y NFTs raros.",
      },
      {
        type: "paragraph",
        content:
          "Esta guía completa te guiará a través de los elementos básicos del juego, te ayudará a entender la misteriosa estructura de Metacube, explicará el sistema de moneda del juego y te preparará para los diversos peligros y desafíos que enfrentarás en tu viaje.",
      },
      ...
      },
      {
        type: "paragraph",
        content:
          "El juego combina elementos de exploración, recolección de recursos y toma de decisiones estratégicas mientras navegas por la superficie del asteroide y la compleja estructura del Metacube. Tus objetivos principales incluyen minar cubos, recolectar datos valiosos, evitar peligros y mejorar tu equipo para acceder a áreas más desafiantes.",
      },
      ...
      { type: "heading", content: "Moneda del Juego y Mejoras" },
      {
        type: "paragraph",
        content:
          'A lo largo del juego, los jugadores acumulan moneda del juego rompiendo cubos y completando varios desafíos. Esta moneda, llamada "MetaCoins" permite a los jugadores mejorar las habilidades de Stove, incluyendo volar, correr y caminar, así como mejorar la potencia y eficiencia del arma de plataforma minera. Las mejoras son esenciales para enfrentar las defensas más formidables del Metacube y aumentar las posibilidades de descubrir NFTs raros.',
      },
      {
        type: "paragraph",
        content:
          "El juego presenta seis tipos diferentes de mejoras, cada una mejorando aspectos específicos de tu experiencia de juego. Estas mejoras pueden impactar significativamente tu eficiencia de minería, capacidades de movimiento y supervivencia general en el entorno hostil de Zerith-9 y el Metacube.",
      },
      ...
      { type: "heading", content: "Explora el Universo Completo de Metacube" },
      {
        type: "paragraph",
        content:
          "Esta guía proporciona solo un vistazo al vasto y emocionante mundo de Metacube. Para profundizar en las mecánicas del juego, colecciones de NFT y planes de desarrollo futuros, te invitamos a consultar nuestro [whitepaper oficial de Metacube](https://metacube-1.gitbook.io/metacube-games).",
      },
      {
        type: "paragraph",
        content: "El whitepaper contiene información extensa sobre:",
      },
      {
        type: "paragraph",
        content:
          "• Mecánicas de juego detalladas y estrategias\n• Desglose completo de coleccionables NFT y su rareza\n• El mercado de NFT y sistema de comercio\n• Utilidad en el juego de varios activos digitales\n• Hoja de ruta de desarrollo futuro incluyendo Temporada 2 y más allá\n• Equipo detrás del desarrollo de Metacube",
      },
      {
        type: "paragraph",
        content:
          "Ya seas un jugador nuevo buscando comenzar o un Stellar Scavenger experimentado buscando estrategias avanzadas, el whitepaper proporciona valiosas perspectivas para mejorar tu experiencia en Metacube.",
      },
    ],
  ...
  "welcome-to-our-new-blog": {
    ...
    excerpt:
      "¡Estamos emocionados de lanzar nuestro nuevo blog! Descubre actualizaciones, guías, destacados de la comunidad y perspectivas sobre el mundo de Metacube.",
    content: [
      { type: "heading", content: "Un Nuevo Centro para Noticias de Metacube" },
      {
        type: "paragraph",
        content:
          "¡Bienvenidos, Metacubers! Estamos encantados de lanzar oficialmente el **Blog de Metacube**, tu nuevo centro principal para todo lo relacionado con nuestro universo en constante expansión. Aquí encontrarás las últimas noticias, actualizaciones de desarrollo, guías de juego detalladas, destacados de la comunidad y mucho más.",
      },
      {
        type: "paragraph",
        content:
          "Nuestro objetivo es proporcionarte una línea directa con el equipo y un lugar para explorar las profundidades de Metacube. Ya seas un *jugador experimentado* o estés comenzando tu viaje, esperamos que este blog se convierta en un recurso valioso para ti.",
      },
      { type: "heading", content: "Qué Esperar" },
      {
        type: "paragraph",
        content:
          "• **Últimos Anuncios:** Sé el primero en conocer sobre nuevas características, próximos eventos y actualizaciones importantes.\n• **Perspectivas de los Desarrolladores:** Obtén una mirada entre bastidores de nuestro proceso de desarrollo, desafíos y planes futuros.\n• **Guías y Consejos del Juego:** Domina Metacube con guías detalladas, estrategias y consejos tanto del equipo como de jugadores experimentados.\n• **Destacados de la Comunidad:** Mostraremos creaciones increíbles, historias de jugadores y eventos organizados por la comunidad. ¡Comparte tu contenido con nosotros!\n• **Historia y Narrativa:** Sumérgete más profundamente en el mundo de Metacube y su rica narrativa.",
      },
      {
        type: "paragraph",
        content:
          "Estamos emocionados de comenzar este nuevo capítulo contigo. ¡Mantente atento para actualizaciones regulares, y no dudes en compartir tus comentarios y sugerencias en nuestros canales de la comunidad!",
      },
    ],
  ...
  "introducing-community-streams": {
    ...
    title:
      "Presentando Transmisiones de la Comunidad: ¡Comparte tus Momentos de Metacube!",
    date: "2025-05-07",
    author: "The Metacube Team",
    imageUrl: "/blog/community_b.jpg",
    excerpt:
      "¡Descubre nuestra nueva sección de Transmisiones de la Comunidad! Observa juego en vivo, comparte tus propias transmisiones y conecta con otros Metacubers.",
    content: [
      { type: "heading", content: "Brilla con tu Juego" },
      {
        type: "paragraph",
        content:
          "Estamos increíblemente emocionados de anunciar el lanzamiento de nuestra nueva sección **Transmisiones de la Comunidad** en el sitio web de Metacube. Este es tu espacio dedicado para descubrir juego en vivo de otros Metacubers y, más importante aún, para compartir tus propias aventuras de Metacube con el mundo.",
      },
      {
        type: "paragraph",
        content:
          "Ya seas un streamer experimentado o solo quieras compartir un momento genial, nuestra página de Transmisiones de la Comunidad lo hace fácil. Puedes enviar enlaces a tus transmisiones en vivo o VODs de plataformas populares como [YouTube](https://youtube.com), [Twitch](https://twitch.tv), y [Kick](https://kick.com).",
      },
      { type: "heading", content: "Qué Encontrarás" },
      {
        type: "paragraph",
        content:
          "• **Transmisiones en Vivo Destacadas:** Destacaremos transmisiones en vivo en curso directamente en la página, facilitando saltar a la acción.\n• **Cuadrícula de Videos de la Comunidad:** Explora una colección de videos y transmisiones pasadas enviadas por jugadores. Descubre nuevas estrategias, construcciones impresionantes, o simplemente disfruta viendo a otros explorar Metacube.\n• **Envío Fácil:** Un formulario simple te permite enviar tu enlace de video o transmisión, agregar una descripción e incluso especificar el idioma de tu contenido.",
      },
      {
        type: "paragraph",
        content:
          "El objetivo es fomentar un espacio vibrante e interactivo donde los jugadores puedan conectar, aprender unos de otros y mostrar las diversas formas en que se experimenta Metacube. ¡No podemos esperar para ver tu contenido!",
      },
      {
        type: "paragraph",
        content:
          "¡Dirígete a la página de Transmisiones de la Comunidad ahora para echarle un vistazo y enviar tu primera transmisión o video!",
      },
    ],
    relatedPosts: ["welcome-to-our-new-blog", "nft-collectibles-guide"],
  },
  "nft-collectibles-guide": {
    ...
    excerpt:
      "Desbloquea los secretos de los coleccionables NFT en Metacube. Esta guía cubre rareza, rasgos y cómo aprovechar al máximo tus activos digitales.",
    content: [
      { type: "heading", content: "Entendiendo los Niveles de Rareza" },
      {
        type: "paragraph",
        content:
          "En Metacube, los coleccionables NFT vienen en varios niveles de rareza, cada uno influenciando su singularidad y valor potencial. Estos niveles son típicamente: **Común, Raro, Épico, Mítico y Legendario**. Cuanto más raro sea el artículo, más distintivos serán sus atributos y apariencia.",
      },
      {
        type: "paragraph",
        content:
      ...
      {
        type: "image",
        content: "/blog/raritynft.png",
        alt: "Gráfico de Distribución de Rareza de NFT",
      },
      {
        type: "paragraph",
        content:
          "La distribución de estas rarezas se gestiona cuidadosamente para garantizar una experiencia de colección equilibrada y atractiva.",
      },
      { type: "heading", content: "Rasgos y Atributos Clave" },
      {
        type: "paragraph",
        content:
          "Cada coleccionable NFT posee un conjunto de rasgos que definen sus características. Estos pueden variar desde elementos visuales como *color* y *diseño* hasta atributos funcionales que pueden afectar el juego o la utilidad dentro del ecosistema de Metacube.",
      },
      {
        type: "paragraph",
        content:
          "Entender estos rasgos es crucial para evaluar el valor y el potencial de un NFT. Los coleccionistas a menudo buscan artículos con combinaciones de rasgos raros o aquellos que complementan su estilo de juego.",
      },
    ],
  ...
  "starknet-transactions-batcher": {
    ...
    excerpt:
      "Aprende sobre el procesador por lotes de transacciones utilizado en Metacube para enviar NFTs ganados por los jugadores al instante, con una implementación detallada en Go.",
    content: [
      ...
      },
      {
        type: "paragraph",
        content:
          "Esta publicación se basa en el artículo publicado originalmente en [dev.to](https://dev.to/bastienfaivre/a-starknet-transactions-batcher-1hpk) por Bastien Faivre.",
      },
      { type: "heading", content: "Arquitectura" },
      {
        type: "paragraph",
        content: "El Batcher se compone de dos actores principales:",
      },
      {
        type: "paragraph",
        content:
      ...
      {
        type: "image",
        content: "/blog/architecture_graph.webp",
        alt: "Arquitectura del Batcher de Starknet",
      },
      ...
      { type: "heading", content: "Builder" },
      {
        type: "paragraph",
        content:
          "Analicemos el actor Build. Ten en cuenta que el código se simplifica para una mejor legibilidad (código completo disponible en [GitHub](https://github.com/metacube-games/starknet-batcher/)).",
      },
      {
        type: "code",
        language: "go",
      ...
      { type: "heading", content: "Sender" },
      {
        type: "paragraph",
        content:
          "Analicemos ahora el actor Sender. Ten en cuenta que el código se simplifica para una mejor legibilidad (código completo disponible en [GitHub](https://github.com/metacube-games/starknet-batcher/)).",
      },
      {
        type: "code",
        language: "go",
      ...
      { type: "heading", content: "Herramienta CLI" },
      {
        type: "paragraph",
        content:
          "El código del repositorio se puede usar como una herramienta CLI para enviar un montón de NFTs por lotes. La herramienta es fácil de usar, y deberías poder adaptarla a tus necesidades después de leer este artículo. Por favor, consulta el [README](https://github.com/metacube-games/starknet-batcher/) para más información.",
      },
      ...
      },
      {
        type: "paragraph",
        content:
          "Para más información, consulta el [artículo original en dev.to](https://dev.to/bastienfaivre/a-starknet-transactions-batcher-1hpk) y el [repositorio de GitHub](https://github.com/metacube-games/starknet-batcher).",
      },
    ],
  ...
  "starknet-signatures-guide": {
    ...
    excerpt:
      "Aprende sobre el proceso de firmar y verificar firmas en Starknet, con ejemplos de código en TypeScript y Go.",
    content: [
      { type: "heading", content: "Resumen" },
      {
        type: "paragraph",
      ...
      },
      {
        type: "paragraph",
        content:
          "Esta publicación se basa en el artículo publicado originalmente en [dev.to](https://dev.to/bastienfaivre/a-guide-on-starknet-signatures-a3m) por Bastien Faivre.",
      },
      ...
      {
        type: "paragraph",
        content: "Aquí hay un ejemplo de firmar un mensaje en TypeScript:",
      },
      {
        type: "code",
        language: "typescript",
      ...
      {
        type: "heading",
        content: "Verificar una firma usando la clave pública",
      },
      {
        type: "paragraph",
        content:
      ...
      {
        type: "heading",
        content: "Verificar una firma usando la dirección de cuenta",
      },
      {
        type: "paragraph",
        content:
      ...
      {
        type: "heading",
        content: "Trabajar con una billetera (Ready Wallet, Braavos, etc.)",
      },
      {
        type: "paragraph",
        content:
      ...
      },
      {
        type: "paragraph",
        content:
          "Para más información, consulta el [artículo original en dev.to](https://dev.to/bastienfaivre/a-guide-on-starknet-signatures-a3m) por Bastien Faivre.",
      },
    ],
