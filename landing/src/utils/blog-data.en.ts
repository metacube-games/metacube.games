...
export const blogPosts: Record<string, BlogPost> = {
  "fidelity-week-event": {
    ...
    excerpt:
      "Learn about Fidelity Week, a special event where our most dedicated players shared 1,000 STRK tokens based on their leaderboard performance.",
    content: [
      { type: "heading", content: "Celebrating Player Dedication" },
      {
        type: "paragraph",
        content:
          "Fidelity Week was a special event designed to thank our most faithful players for their continued support and dedication to Metacube. During this week-long celebration, top performers on the leaderboard shared a prize pool of 1,000 STRK tokens as a token of our appreciation.",
      },
      ...
      { type: "heading", content: "Prize Distribution" },
      {
        type: "paragraph",
        content:
          "The 1,000 STRK token prize pool was distributed proportionally among the top performers on the leaderboard, with higher-ranked players receiving larger shares of the rewards. This created an exciting competition where every point mattered in the race for the top positions.",
      },

      {
        type: "paragraph",
        content:
          "Fidelity Week demonstrated our commitment to recognizing and rewarding the most dedicated members of our community. Keep an eye out for future Fidelity Week events and other special opportunities to earn rewards in the Metacube universe!",
      },
    ],
    relatedPosts: [
  ...
  "special-events-in-metacube": {
    ...
    excerpt:
      "Discover the exciting world of Metacube's special events that transform gameplay and offer unique rewards for a limited time, including STRK tokens.",
    content: [
      { type: "heading", content: "Introducing Metacube Special Events" },
      {
        type: "paragraph",
        content:
          "At Metacube, we regularly host special time-limited events that transform the Metacube universe in unexpected ways. These events provide unique challenges, exclusive rewards including STRK tokens, and memorable experiences that you won't find during regular gameplay.",
      },
      ...
      { type: "heading", content: "Event Highlights" },
      {
        type: "paragraph",
        content:
          "Our community has already experienced some unforgettable events:",
      },
      {
        type: "paragraph",
        content:
          "• **Crypto Rave Pulse**: An innovative event where Pelton Flusk used giant speakers emitting rave music to nullify Metacube's electric defenses.\n• **Monkecube**: A total transformation where Metacube became Monkecube, featuring monkey-themed base skins and a complete rebrand (even monkecube.com redirected to metacube.games).",
      },
      ...
      { type: "heading", content: "Event Rewards" },
      {
        type: "paragraph",
        content:
          "So far, our events have rewarded players with **STRK Tokens** based on their leaderboard position. Future events may include other rewards such as NFTs and special skins.",
      },
      ...
      { type: "heading", content: "STRK Leaderboard System" },
      {
        type: "paragraph",
        content:
          "During events, players compete on a leaderboard to earn STRK tokens. Your position is determined by three key factors:\n• The number of cubes broken during the event\n• The total number of coins collected\n• Penalties for deaths during the event",
      },

      {
        type: "paragraph",
        content:
          "Check out our detailed coverage of past events like **Monkecube** and **Crypto Rave Pulse** to get a taste of what's possible in the ever-changing Metacube universe. And remember—in a game with a finite lifespan, every special event is truly a once-in-a-lifetime experience!",
      },
    ],
  ...
  "monkecube-event": {
    ...
    excerpt:
      "Revisit the Monkecube event, when the entire Metacube was renamed and transformed with monkey-themed base skins.",
    content: [
      { type: "heading", content: "The Monkecube Transformation" },
      {
        type: "paragraph",
        content:
          "During this special event, Metacube underwent a complete transformation and was renamed to **Monkecube**. This wasn't just a small cosmetic change—it was a full rebrand of the game experience.",
      },
      ...
      { type: "heading", content: "Event Rewards" },
      {
        type: "paragraph",
        content:
          "Participants in the Monkecube event competed for **STRK Tokens**, which were awarded based on the event leaderboard. The leaderboard tracked the number of cubes broken, coins collected, and applied penalties for player deaths.",
      },
      ...
      { type: "heading", content: "Community Reactions" },
      {
        type: "paragraph",
        content:
          "The Monkecube event quickly became a fan favorite, with the community embracing the unexpected primal transformation. The lighthearted nature of Monkecube provided a refreshing change of pace from the usual Metacube experience.",
      },

      {
        type: "paragraph",
        content:
          "Did you participate in the Monkecube event? Share your memories in our Discord channel or in the comments below!",
      },
    ],
  ...
  "crypto-rave-pulse-event": {
    ...
    excerpt:
      "Experience the Crypto Rave Pulse event, where Pelton Flusk used massive sound systems and rave music to nullify the Metacube's electric defenses.",
    content: [
      { type: "heading", content: "Sound vs. Electric Defenses" },
      {
        type: "paragraph",
        content:
          "The Crypto Rave Pulse was a groundbreaking event in the Metacube universe. During this period, Pelton Flusk deployed giant speakers around the Metacube perimeter, emitting powerful rave music specifically calibrated to nullify the Cube's electric defense systems.",
      },
      ...
      { type: "heading", content: "Gameplay Impact" },
      {
        type: "paragraph",
        content:
          "Normally, the Metacube's defenses cause damage to players who interact with them, though they don't prevent movement. During the Crypto Rave Pulse event, these defenses were neutralized by the music, allowing players to navigate without taking damage from the cube's defense mechanisms.",
      },
      ...
      { type: "heading", content: "Event Soundtrack" },
      {
        type: "paragraph",
        content:
          "The complete Crypto Rave Pulse soundtrack, composed by Pelton Flusk himself, is available on SoundCloud. You can listen to all tracks from this special event at: [Crypto Rave Pulse by Pelton Flusk](https://soundcloud.com/metacubegames/sets/crypto-rave-pulse-by-pelton-flusk).",
      },
      ...
      { type: "heading", content: "Event Rewards" },
      {
        type: "paragraph",
        content:
          "Players who participated in the Crypto Rave Pulse event competed for **STRK Tokens** based on their leaderboard position. The leaderboard ranking was calculated from the number of cubes broken and coins collected, with penalties applied for deaths during the event.",
      },

      {
        type: "paragraph",
        content:
          "The Crypto Rave Pulse demonstrated how Metacube continually evolves through creative, limited-time events that offer both entertainment and valuable rewards.",
      },
    ],
  ...
  "metacube-gameplay-guide": {
    ...
    excerpt:
      "Dive into Metacube's exciting gameplay mechanics, learn about the mysterious Metacube structure, in-game currency, and overcome challenging hazards in this comprehensive guide.",
    content: [
      { type: "heading", content: "Introduction to Metacube" },
      {
        type: "paragraph",
        content:
          "Metacube is a revolutionary free-to-play NFT game that combines the excitement of treasure hunting, the intrigue of blockchain technology, and the thrill of interstellar exploration. In this immersive gaming experience, players assume the role of Stove the Crypto Raver, a die-hard fan of cryptocurrency and a regular at interstellar raves. Alongside fellow Stellar Scavengers, players embark on a daring mission to unlock the secrets of the Metacube, a celestial vault containing valuable blockchain data and rare NFTs.",
      },
      {
        type: "paragraph",
        content:
          "This comprehensive guide will walk you through the core gameplay elements, help you understand the mysterious Metacube structure, explain the in-game currency system, and prepare you for the various hazards and challenges you'll face on your journey.",
      },
      ...
      },
      {
        type: "paragraph",
        content:
          "The game combines elements of exploration, resource gathering, and strategic decision-making as you navigate the asteroid's surface and the Metacube's complex structure. Your main objectives include mining cubes, collecting valuable data, avoiding hazards, and upgrading your equipment to access more challenging areas.",
      },
      ...
      { type: "heading", content: "The Metacube: A Colossal Crypto Mystery" },
      {
        type: "paragraph",
        content:
          "The Metacube is the central focus of the game, a colossal structure made up of 256x256x256 individual cubes. Each smaller cube bears a symbol representing a cryptocurrency, such as Bitcoin or Ethereum, or a unique piece of blockchain data. The Metacube's creators imbued it with advanced AI defenses and hidden hazards, making the journey to uncover its secrets a challenging and thrilling endeavor.",
      },
      {
        type: "paragraph",
        content:
          "As you explore the Metacube, you'll discover various sections with different difficulty levels and rewards. Some areas might contain rare NFTs but are guarded by more powerful defenses. Understanding the Metacube's structure and planning your mining strategy accordingly will be crucial to your success.",
      },
      ...
      },
      {
        type: "paragraph",
        content:
          "The game features six different types of upgrades, each enhancing specific aspects of your gameplay experience. These upgrades can significantly impact your mining efficiency, movement capabilities, and overall survival in the hostile environment of Zerith-9 and the Metacube.",
      },
      ...
      { type: "heading", content: "Explore the Complete Metacube Universe" },
      {
        type: "paragraph",
        content:
          "This guide provides just a glimpse into the vast and exciting world of Metacube. To dive deeper into the game mechanics, NFT collections, and future development plans, we invite you to check out our [official Metacube whitepaper](https://metacube-1.gitbook.io/metacube-games).",
      },
      {
        type: "paragraph",
        content: "The whitepaper contains extensive information about:",
      },
      {
        type: "paragraph",
        content:
      ...
      },
      {
        type: "paragraph",
        content:
          "Whether you're a new player looking to get started or a seasoned Stellar Scavenger seeking advanced strategies, the whitepaper provides valuable insights to enhance your Metacube experience.",
      },
    ],
  ...
  "welcome-to-our-new-blog": {
    ...
    excerpt:
      "We're excited to launch our new blog! Discover updates, guides, community highlights, and insights into the world of Metacube.",
    content: [
      { type: "heading", content: "A New Hub for Metacube News" },
      {
        type: "paragraph",
        content:
          "Welcome, Metacubers! We are thrilled to officially launch the **Metacube Blog**, your new central hub for all things related to our ever-expanding universe. Here, you'll find the latest news, development updates, in-depth game guides, community spotlights, and much more.",
      },
      {
        type: "paragraph",
        content:
          "Our goal is to provide you with a direct line to the team and a place to explore the depths of Metacube. Whether you're a *seasoned player* or just starting your journey, we hope this blog becomes a valuable resource for you.",
      },
      { type: "heading", content: "What to Expect" },
      {
        type: "paragraph",
        content:
          "• **Latest Announcements:** Be the first to know about new features, upcoming events, and major updates.\n• **Developer Insights:** Get a behind-the-scenes look at our development process, challenges, and future plans.\n• **Game Guides & Tips:** Master Metacube with detailed guides, strategies, and tips from both the team and experienced players.\n• **Community Highlights:** We'll be showcasing amazing creations, player stories, and community-run events. Share your content with us!\n• **Lore & Story:** Dive deeper into the world of Metacube and its rich narrative.",
      },
      {
        type: "paragraph",
        content:
          "We're excited to start this new chapter with you. Stay tuned for regular updates, and don't hesitate to share your feedback and suggestions in our community channels!",
      },
    ],
  ...
  "introducing-community-streams": {
    ...
    excerpt:
      "Discover our new Community Streams section! Watch live gameplay, share your own streams, and connect with fellow Metacubers.",
    content: [
      { type: "heading", content: "Shine a Spotlight on Your Gameplay" },
      {
        type: "paragraph",
        content:
          "We're incredibly excited to announce the launch of our brand new **Community Streams** section on the Metacube website! This is your dedicated space to discover live gameplay from fellow Metacubers and, more importantly, to share your own Metacube adventures with the world.",
      },
      {
        type: "paragraph",
        content:
          "Whether you're a seasoned streamer or just want to share a cool moment, our Community Streams page makes it easy. You can submit links to your live streams or VODs from popular platforms like [YouTube](https://youtube.com), [Twitch](https://twitch.tv), and [Kick](https://kick.com).",
      },
      { type: "heading", content: "What You'll Find" },
      {
        type: "paragraph",
        content:
          "• **Featured Live Streams:** We'll be highlighting ongoing live streams directly on the page, making it easy to jump into the action.\n• **Community Video Grid:** Browse a collection of videos and past streams submitted by players. Discover new strategies, impressive builds, or just enjoy watching others explore Metacube.\n• **Easy Submission:** A simple form allows you to submit your video or stream link, add a description, and even specify the language of your content.",
      },
      {
        type: "paragraph",
        content:
          "The goal is to foster a vibrant and interactive space where players can connect, learn from each other, and showcase the diverse ways Metacube is experienced. We can't wait to see your content!",
      },
      {
        type: "paragraph",
        content:
          "Head over to the Community Streams page now to check it out and submit your first stream or video!",
      },
    ],
    relatedPosts: ["welcome-to-our-new-blog", "nft-collectibles-guide"],
  },
  "nft-collectibles-guide": {
    ...
    excerpt:
      "Unlock the secrets of NFT collectibles in Metacube. This guide covers rarity, traits, and how to make the most of your digital assets.",
    content: [
      { type: "heading", content: "Understanding Rarity Tiers" },
      {
        type: "paragraph",
        content:
          "In Metacube, NFT collectibles come in various rarity tiers, each influencing their uniqueness and potential value. These tiers are typically: **Common, Rare, Epic, Mythic and Legendary**. The rarer the item, the more distinct its attributes and appearance.",
      },
      {
        type: "paragraph",
        content:
      ...
      },
      {
        ...
        alt: "NFT Rarity Distribution Chart",
      },
      {
        type: "paragraph",
        content:
          "The distribution of these rarities is carefully managed to ensure a balanced and engaging collecting experience.",
      },
      { type: "heading", content: "Key Traits and Attributes" },
      {
        type: "paragraph",
        content:
          "Each NFT collectible possesses a set of traits that define its characteristics. These can range from visual elements like *color* and *design* to functional attributes that might affect gameplay or utility within the Metacube ecosystem.",
      },
      {
        type: "paragraph",
        content:
          "Understanding these traits is crucial for assessing an NFT's value and potential. Collectors often seek out items with rare trait combinations or those that complement their playstyle.",
      },
    ],
  ...
  "starknet-transactions-batcher": {
    ...
    excerpt:
      "Learn about the transactions batcher used in Metacube to send NFTs earned by players instantly, with a detailed implementation in Go.",
    content: [
      { type: "heading", content: "Abstract" },
      {
        type: "paragraph",
        content:
          "This article presents the transactions batcher used in Metacube to send NFTs earned by players instantly. It explains the batcher's scalable actor-based architecture and provides a detailed implementation in Go. All the code snippets are available in the associated [GitHub repository](https://github.com/metacube-games/starknet-batcher).",
      },
      {
        type: "paragraph",
        content:
          "This post is based on the article originally published on [dev.to](https://dev.to/bastienfaivre/a-starknet-transactions-batcher-1hpk) by Bastien Faivre.",
      },
      { type: "heading", content: "Architecture" },
      {
        type: "paragraph",
        content: "The Batcher is composed of two main actors:",
      },
      {
        type: "paragraph",
        content:
      ...
      },
      {
        ...
        alt: "Starknet Batcher Architecture",
      },
      ...
      { type: "heading", content: "Builder" },
      {
        type: "paragraph",
        content:
          "Let's analyze the Build actor. Note that the code is simplified for better readability (full code available on [GitHub](https://github.com/metacube-games/starknet-batcher/)).",
      },
      {
        type: "code",
        language: "go",
      ...
      { type: "heading", content: "Sender" },
      {
        type: "paragraph",
        content:
          "Let's now analyze the Sender actor. Note that the code is simplified for better readability (full code available on [GitHub](https://github.com/metacube-games/starknet-batcher/)).",
      },
      {
        type: "code",
        language: "go",
      ...
      { type: "heading", content: "CLI tool" },
      {
        type: "paragraph",
        content:
          "The repository code can be used as a CLI tool to send a bunch of NFTs by batch. The tool is easy to use, and you should be able to adapt it to your needs after reading this article. Please refer to the [README](https://github.com/metacube-games/starknet-batcher/) for more information.",
      },
      ...
      },
      {
        type: "paragraph",
        content:
          "For more information, check out the [original article on dev.to](https://dev.to/bastienfaivre/a-starknet-transactions-batcher-1hpk) and the [GitHub repository](https://github.com/metacube-games/starknet-batcher).",
      },
    ],
  ...
  "starknet-signatures-guide": {
    ...
    excerpt:
      "Learn about the process of signing and verifying signatures on Starknet, with code examples in TypeScript and Go.",
    content: [
      { type: "heading", content: "Abstract" },
      {
        type: "paragraph",
      ...
      },
      {
        type: "paragraph",
        content:
          "This post is based on the article originally published on [dev.to](https://dev.to/bastienfaivre/a-guide-on-starknet-signatures-a3m) by Bastien Faivre.",
      },
      ...
      {
        type: "paragraph",
        content: "Here's an example of signing a message in TypeScript:",
      },
      {
        type: "code",
        language: "typescript",
      ...
      {
        type: "heading",
        content: "Verifying a signature using the public key",
      },
      {
        type: "paragraph",
        content:
      ...
      {
        type: "heading",
        content: "Verifying a signature using the account address",
      },
      {
        type: "paragraph",
        content:
      ...
      {
        type: "heading",
        content: "Working with a wallet (Ready Wallet, Braavos, etc.)",
      },
      {
        type: "paragraph",
        content:
          "When working with a wallet like Ready Wallet or Braavos, you typically won't have direct access to the user's private key. Instead, you'll need to use the wallet's interface to request the user to sign a message.",
      },
      {
        type: "code",
        language: "typescript",
      ...
      },
      {
        type: "paragraph",
        content:
          "For more information, check out the [original article on dev.to](https://dev.to/bastienfaivre/a-guide-on-starknet-signatures-a3m) by Bastien Faivre.",
      },
    ],
