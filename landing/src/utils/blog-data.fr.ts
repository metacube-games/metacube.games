...
export const blogPosts: Record<string, BlogPost> = {
  "fidelity-week-event": {
    ...
    content: [
      ...
      { type: "heading", content: "Distribution des Prix" },
      {
        type: "paragraph",
        content:
          "La cagnotte de 1 000 tokens STRK a été distribuée proportionnellement parmi les meilleurs joueurs du classement, les joueurs les mieux classés recevant des parts plus importantes des récompenses. Cela a créé une compétition passionnante où chaque point comptait dans la course aux premières positions.",
      },

      {
        type: "paragraph",
        content:
          "La Semaine de Fidélité a démontré notre engagement à reconnaître et récompenser les membres les plus dévoués de notre communauté. Gardez un œil ouvert pour de futures Semaines de Fidélité et d'autres opportunités spéciales de gagner des récompenses dans l'univers Metacube !",
      },
    ],
    relatedPosts: [
  ...
  "special-events-in-metacube": {
    ...
    excerpt:
      "Découvrez le monde passionnant des événements spéciaux de Metacube qui transforment le gameplay et offrent des récompenses uniques pour une durée limitée, y compris des tokens STRK.",
    content: [
      {
        type: "heading",
        content: "Présentation des Événements Spéciaux Metacube",
      },
      {
        type: "paragraph",
        content:
          "Chez Metacube, nous organisons régulièrement des événements spéciaux à durée limitée qui transforment l'univers Metacube de manière inattendue. Ces événements offrent des défis uniques, des récompenses exclusives incluant des tokens STRK, et des expériences mémorables que vous ne trouverez pas pendant le gameplay normal.",
      },

      { type: "heading", content: "Temps Forts des Événements" },
      {
        type: "paragraph",
        content: "Notre communauté a déjà vécu des événements inoubliables :",
      },
      {
        type: "paragraph",
        content:
          "• **Crypto Rave Pulse** : Un événement innovant où Pelton Flusk a utilisé des haut-parleurs géants émettant de la musique rave pour neutraliser les défenses électriques de Metacube.\n• **Monkecube** : Une transformation totale où Metacube est devenu Monkecube, avec des skins de base sur le thème des singes et un rebranding complet (même monkecube.com redirigeait vers metacube.games).",
      },
      ...
      { type: "heading", content: "Récompenses des Événements" },
      {
        type: "paragraph",
        content:
          "Jusqu'à présent, nos événements ont récompensé les joueurs avec des **Tokens STRK** en fonction de leur position au classement. Les futurs événements pourraient inclure d'autres récompenses telles que des NFT et des skins spéciaux.",
      },
  ...
  "monkecube-event": {
    ...
    excerpt:
      "Revivez l'événement Monkecube, lorsque l'intégralité de Metacube a été renommé et transformé avec des skins de base sur le thème des singes.",
    content: [
      { type: "heading", content: "La Transformation Monkecube" },
      {
        type: "paragraph",
        content:
          "Durant cet événement spécial, Metacube a subi une transformation complète et a été renommé **Monkecube**. Ce n'était pas qu'un simple changement cosmétique — c'était un rebranding complet de l'expérience de jeu.",
      },
      ...
      { type: "heading", content: "Récompenses de l'Événement" },
      {
        type: "paragraph",
        content:
          "Les participants à l'événement Monkecube se sont affrontés pour des **Tokens STRK**, qui ont été attribués en fonction du classement de l'événement. Le classement suivait le nombre de cubes cassés, les pièces collectées et appliquait des pénalités pour les morts des joueurs.",
      },
      ...
      { type: "heading", content: "Réactions de la Communauté" },
      {
        type: "paragraph",
        content:
          "L'événement Monkecube est rapidement devenu un favori des fans, la communauté embrassant la transformation primale inattendue. La nature légère de Monkecube a fourni un changement de rythme rafraîchissant par rapport à l'expérience Metacube habituelle.",
      },

      {
        type: "paragraph",
        content:
          "Avez-vous participé à l'événement Monkecube ? Partagez vos souvenirs sur notre canal Discord ou dans les commentaires ci-dessous !",
      },
    ],
  ...
  "crypto-rave-pulse-event": {
    ...
    excerpt:
      "Découvrez l'événement Crypto Rave Pulse, où Pelton Flusk a utilisé des systèmes de son massifs et de la musique rave pour neutraliser les défenses électriques de Metacube.",
    content: [
      { type: "heading", content: "Le Son contre les Défenses Électriques" },
      {
        type: "paragraph",
        content:
          "Le Crypto Rave Pulse était un événement révolutionnaire dans l'univers Metacube. Durant cette période, Pelton Flusk a déployé des haut-parleurs géants autour du périmètre de Metacube, émettant de la musique rave puissante spécifiquement calibrée pour neutraliser les systèmes de défense électrique du Cube.",
      },
      ...
      { type: "heading", content: "Bande-Son de l'Événement" },
      {
        type: "paragraph",
        content:
          "La bande-son complète de Crypto Rave Pulse, composée par Pelton Flusk lui-même, est disponible sur SoundCloud. Vous pouvez écouter toutes les pistes de cet événement spécial sur : [Crypto Rave Pulse by Pelton Flusk](https://soundcloud.com/metacubegames/sets/crypto-rave-pulse-by-pelton-flusk).",
      },
      ...
      { type: "heading", content: "Récompenses de l'Événement" },
      {
        type: "paragraph",
        content:
          "Les joueurs qui ont participé à l'événement Crypto Rave Pulse se sont affrontés pour des **Tokens STRK** en fonction de leur position au classement. Le classement était calculé à partir du nombre de cubes cassés et de pièces collectées, avec des pénalités appliquées pour les morts durant l'événement.",
      },

      {
        type: "paragraph",
        content:
          "Le Crypto Rave Pulse a démontré comment Metacube évolue continuellement à travers des événements créatifs à durée limitée qui offrent à la fois divertissement et récompenses précieuses.",
      },
    ],
  ...
  "metacube-gameplay-guide": {
    ...
    excerpt:
      "Plongez dans les mécaniques de gameplay passionnantes de Metacube, découvrez la mystérieuse structure Metacube, la monnaie du jeu et surmontez les dangers difficiles dans ce guide complet.",
    content: [
      { type: "heading", content: "Introduction à Metacube" },
      {
        type: "paragraph",
        content:
          "Metacube est un jeu NFT gratuit révolutionnaire qui combine l'excitation de la chasse au trésor, l'intrigue de la technologie blockchain et le frisson de l'exploration interstellaire. Dans cette expérience de jeu immersive, les joueurs assument le rôle de Stove the Crypto Raver, un fan inconditionnel de cryptomonnaie et un habitué des raves interstellaires. Aux côtés d'autres Stellar Scavengers, les joueurs se lancent dans une mission audacieuse pour déverrouiller les secrets du Metacube, un coffre-fort céleste contenant de précieuses données blockchain et des NFT rares.",
      },
      {
        type: "paragraph",
        content:
          "Ce guide complet vous guidera à travers les éléments de gameplay de base, vous aidera à comprendre la mystérieuse structure Metacube, expliquera le système de monnaie du jeu et vous préparera aux divers dangers et défis que vous rencontrerez lors de votre voyage.",
      },
      ...
      { type: "heading", content: "Explorez l'Univers Metacube Complet" },
      {
        type: "paragraph",
        content:
          "Ce guide ne fournit qu'un aperçu du monde vaste et passionnant de Metacube. Pour plonger plus profondément dans les mécaniques du jeu, les collections NFT et les plans de développement futurs, nous vous invitons à consulter notre [livre blanc officiel Metacube](https://metacube-1.gitbook.io/metacube-games).",
      },
      {
        type: "paragraph",
        content: "Le livre blanc contient des informations complètes sur :",
      },
      {
        type: "paragraph",
        content:
          "• Les mécaniques de gameplay détaillées et les stratégies\n• La répartition complète des objets de collection NFT et de leur rareté\n• Le marché NFT et le système d'échange\n• L'utilité en jeu de divers actifs numériques\n• La feuille de route de développement futur incluant la Saison 2 et au-delà\n• L'équipe derrière le développement de Metacube",
      },
      {
        type: "paragraph",
        content:
          "Que vous soyez un nouveau joueur cherchant à démarrer ou un Stellar Scavenger expérimenté à la recherche de stratégies avancées, le livre blanc fournit des informations précieuses pour améliorer votre expérience Metacube.",
      },
    ],
  ...
  "introducing-community-streams": {
    ...
    title:
      "Présentation des Streams Communautaires : Partagez Vos Moments Metacube !",
    date: "2025-05-07",
    author: "The Metacube Team",
    imageUrl: "/blog/community_b.jpg",
    excerpt:
      "Découvrez notre nouvelle section Streams Communautaires ! Regardez du gameplay en direct, partagez vos propres streams et connectez-vous avec d'autres Metacubers.",
    content: [
      { type: "heading", content: "Mettez en Lumière Votre Gameplay" },
      {
        type: "paragraph",
        content:
          "Nous sommes extrêmement ravis d'annoncer le lancement de notre toute nouvelle section **Streams Communautaires** sur le site web Metacube ! C'est votre espace dédié pour découvrir du gameplay en direct d'autres Metacubers et, plus important encore, pour partager vos propres aventures Metacube avec le monde.",
      },
      {
        type: "paragraph",
        content:
          "Que vous soyez un streamer chevronné ou que vous souhaitiez simplement partager un moment cool, notre page Streams Communautaires le rend facile. Vous pouvez soumettre des liens vers vos streams en direct ou VOD depuis des plateformes populaires comme [YouTube](https://youtube.com), [Twitch](https://twitch.tv) et [Kick](https://kick.com).",
      },
      { type: "heading", content: "Ce Que Vous Trouverez" },
      {
        type: "paragraph",
        content:
          "• **Streams en Direct Mis en Avant :** Nous mettrons en avant les streams en direct en cours directement sur la page, facilitant le saut dans l'action.\n• **Grille Vidéo Communautaire :** Parcourez une collection de vidéos et de streams passés soumis par les joueurs. Découvrez de nouvelles stratégies, des constructions impressionnantes ou profitez simplement de regarder d'autres explorer Metacube.\n• **Soumission Facile :** Un formulaire simple vous permet de soumettre votre lien vidéo ou stream, d'ajouter une description et même de spécifier la langue de votre contenu.",
      },
      {
        type: "paragraph",
        content:
          "L'objectif est de favoriser un espace dynamique et interactif où les joueurs peuvent se connecter, apprendre les uns des autres et mettre en valeur les différentes façons dont Metacube est vécu. Nous avons hâte de voir votre contenu !",
      },
      {
        type: "paragraph",
        content:
          "Rendez-vous sur la page Streams Communautaires maintenant pour la découvrir et soumettre votre premier stream ou vidéo !",
      },
    ],
    relatedPosts: ["welcome-to-our-new-blog", "nft-collectibles-guide"],
  },
  "nft-collectibles-guide": {
    ...
    excerpt:
      "Débloquez les secrets des objets de collection NFT dans Metacube. Ce guide couvre la rareté, les traits et comment tirer le meilleur parti de vos actifs numériques.",
    content: [
      { type: "heading", content: "Comprendre les Niveaux de Rareté" },
      {
        type: "paragraph",
        content:
          "Dans Metacube, les objets de collection NFT existent en différents niveaux de rareté, chacun influençant leur unicité et leur valeur potentielle. Ces niveaux sont généralement : **Commun, Rare, Épique, Mythique et Légendaire**. Plus l'objet est rare, plus ses attributs et son apparence sont distincts.",
      },
      {
        type: "paragraph",
        content:
      ...
      },
      {
        ...
        alt: "Graphique de Distribution de Rareté NFT",
      },
      {
        type: "paragraph",
        content:
          "La distribution de ces raretés est soigneusement gérée pour garantir une expérience de collection équilibrée et engageante.",
      },
      { type: "heading", content: "Traits et Attributs Clés" },
      {
        type: "paragraph",
        content:
          "Chaque objet de collection NFT possède un ensemble de traits qui définissent ses caractéristiques. Ceux-ci peuvent aller d'éléments visuels comme la *couleur* et le *design* à des attributs fonctionnels qui pourraient affecter le gameplay ou l'utilité au sein de l'écosystème Metacube.",
      },
      {
        type: "paragraph",
        content:
          "Comprendre ces traits est crucial pour évaluer la valeur et le potentiel d'un NFT. Les collectionneurs recherchent souvent des objets avec des combinaisons de traits rares ou ceux qui complètent leur style de jeu.",
      },
    ],
  ...
  "starknet-transactions-batcher": {
    ...
    excerpt:
      "Découvrez le système de traitement par lots des transactions utilisé dans Metacube pour envoyer instantanément les NFT gagnés par les joueurs, avec une implémentation détaillée en Go.",
    content: [
      { type: "heading", content: "Résumé" },
      {
        type: "paragraph",
        content:
          "Cet article présente le système de traitement par lots des transactions utilisé dans Metacube pour envoyer instantanément les NFT gagnés par les joueurs. Il explique l'architecture évolutive basée sur des acteurs du système et fournit une implémentation détaillée en Go. Tous les extraits de code sont disponibles dans le [dépôt GitHub](https://github.com/metacube-games/starknet-batcher) associé.",
      },
      {
        type: "paragraph",
        content:
          "Cet article est basé sur l'article initialement publié sur [dev.to](https://dev.to/bastienfaivre/a-starknet-transactions-batcher-1hpk) par Bastien Faivre.",
      },
      { type: "heading", content: "Architecture" },
      {
        type: "paragraph",
        content: "Le Batcher est composé de deux acteurs principaux :",
      },
      {
        type: "paragraph",
        content:
      ...
      },
      {
        ...
        alt: "Architecture du Batcher Starknet",
      },
      ...
      { type: "heading", content: "Builder" },
      {
        type: "paragraph",
        content:
          "Analysons l'acteur Build. Notez que le code est simplifié pour une meilleure lisibilité (code complet disponible sur [GitHub](https://github.com/metacube-games/starknet-batcher/)).",
      },
      {
        type: "code",
        language: "go",
      ...
      { type: "heading", content: "Sender" },
      {
        type: "paragraph",
        content:
          "Analysons maintenant l'acteur Sender. Notez que le code est simplifié pour une meilleure lisibilité (code complet disponible sur [GitHub](https://github.com/metacube-games/starknet-batcher/)).",
      },
      {
        type: "code",
        language: "go",
      ...
      { type: "heading", content: "Outil CLI" },
      {
        type: "paragraph",
        content:
          "Le code du dépôt peut être utilisé comme outil CLI pour envoyer un lot de NFT par lots. L'outil est facile à utiliser, et vous devriez pouvoir l'adapter à vos besoins après avoir lu cet article. Veuillez consulter le [README](https://github.com/metacube-games/starknet-batcher/) pour plus d'informations.",
      },
      ...
      },
      {
        type: "paragraph",
        content:
          "Pour plus d'informations, consultez l'[article original sur dev.to](https://dev.to/bastienfaivre/a-starknet-transactions-batcher-1hpk) et le [dépôt GitHub](https://github.com/metacube-games/starknet-batcher).",
      },
    ],
  ...
  "starknet-signatures-guide": {
    ...
    excerpt:
      "Découvrez le processus de signature et de vérification des signatures sur Starknet, avec des exemples de code en TypeScript et Go.",
    content: [
      { type: "heading", content: "Résumé" },
      {
        type: "paragraph",
      ...
      },
      {
        type: "paragraph",
        content:
          "Cet article est basé sur l'article initialement publié sur [dev.to](https://dev.to/bastienfaivre/a-guide-on-starknet-signatures-a3m) par Bastien Faivre.",
      },
      ...
      {
        type: "paragraph",
        content: "Voici un exemple de signature d'un message en TypeScript :",
      },
      {
        type: "code",
        language: "typescript",
      ...
      {
        type: "heading",
        content: "Vérifier une signature en utilisant la clé publique",
      },
      {
        type: "paragraph",
        content:
      ...
      {
        type: "heading",
        content: "Vérifier une signature en utilisant l'adresse du compte",
      },
      {
        type: "paragraph",
        content:
      ...
      },
      {
        type: "heading",
        content:
          "Travailler avec un portefeuille (Ready Wallet, Braavos, etc.)",
      },
      {
        type: "paragraph",
        content:
      ...
      },
      {
        type: "paragraph",
        content:
          "Pour plus d'informations, consultez l'[article original sur dev.to](https://dev.to/bastienfaivre/a-guide-on-starknet-signatures-a3m) par Bastien Faivre.",
      },
    ],
