...
export const blogPosts: Record<string, BlogPost> = {
  "fidelity-week-event": {
    ...
    excerpt:
      "Erfahren Sie mehr über die Treue-Woche, ein besonderes Event, bei dem unsere treuesten Spieler 1.000 STRK-Token basierend auf ihrer Ranglisten-Performance teilten.",
    content: [
      ...
      { type: "heading", content: "Preisverteilung" },
      {
        type: "paragraph",
        content:
          "Der Preispool von 1.000 STRK-Token wurde proportional unter den Top-Performern auf der Rangliste verteilt, wobei höher platzierte Spieler größere Anteile der Belohnungen erhielten. Dies schuf einen spannenden Wettbewerb, bei dem jeder Punkt im Rennen um die Top-Positionen zählte.",
      },

      {
        type: "paragraph",
        content:
          "Die Treue-Woche demonstrierte unser Engagement, die engagiertesten Mitglieder unserer Community anzuerkennen und zu belohnen. Halten Sie Ausschau nach zukünftigen Treue-Wochen-Events und anderen besonderen Gelegenheiten, um Belohnungen im Metacube-Universum zu verdienen!",
      },
    ],
    relatedPosts: [
  ...
  "special-events-in-metacube": {
    ...
    excerpt:
      "Entdecken Sie die aufregende Welt der speziellen Events von Metacube, die das Gameplay transformieren und für begrenzte Zeit einzigartige Belohnungen bieten, einschließlich STRK-Token.",
    content: [
      {
        type: "heading",
        content: "Vorstellung der speziellen Metacube-Events",
      },
      {
        type: "paragraph",
        content:
          "Bei Metacube veranstalten wir regelmäßig spezielle, zeitlich begrenzte Events, die das Metacube-Universum auf unerwartete Weise transformieren. Diese Events bieten einzigartige Herausforderungen, exklusive Belohnungen einschließlich STRK-Token und unvergessliche Erfahrungen, die Sie während des regulären Gameplays nicht finden werden.",
      },
      ...
      { type: "heading", content: "Event-Highlights" },
      {
        type: "paragraph",
        content:
          "Unsere Community hat bereits einige unvergessliche Events erlebt:",
      },
      {
        type: "paragraph",
        content:
          "• **Crypto Rave Pulse**: Ein innovatives Event, bei dem Pelton Flusk riesige Lautsprecher einsetzte, die Rave-Musik ausstrahlten, um Metacubes elektrische Verteidigung zu neutralisieren.\n• **Monkecube**: Eine totale Transformation, bei der Metacube zu Monkecube wurde, mit Affen-Basis-Skins und einem kompletten Rebranding (sogar monkecube.com leitete zu metacube.games weiter).",
      },
      ...
      { type: "heading", content: "Event-Belohnungen" },
      {
        type: "paragraph",
        content:
          "Bisher haben unsere Events Spieler mit **STRK-Token** basierend auf ihrer Ranglisten-Position belohnt. Zukünftige Events könnten auch andere Belohnungen wie NFTs und spezielle Skins beinhalten.",
      },
      ...
      { type: "heading", content: "STRK-Ranglisten-System" },
      {
        type: "paragraph",
        content:
          "Während Events konkurrieren Spieler auf einer Rangliste, um STRK-Token zu verdienen. Ihre Position wird durch drei Schlüsselfaktoren bestimmt:\n• Die Anzahl der während des Events zerstörten Würfel\n• Die Gesamtzahl der gesammelten Münzen\n• Strafen für Todesfälle während des Events",
      },

      {
        type: "paragraph",
        content:
          "Schauen Sie sich unsere detaillierte Berichterstattung über vergangene Events wie **Monkecube** und **Crypto Rave Pulse** an, um einen Eindruck davon zu bekommen, was im sich ständig verändernden Metacube-Universum möglich ist. Und denken Sie daran – in einem Spiel mit begrenzter Lebensdauer ist jedes besondere Event wirklich eine einmalige Erfahrung!",
      },
    ],
  ...
  "monkecube-event": {
    ...
    excerpt:
      "Erleben Sie das Monkecube-Event noch einmal, als der gesamte Metacube umbenannt und mit Affen-Basis-Skins transformiert wurde.",
    content: [
      { type: "heading", content: "Die Monkecube-Transformation" },
      {
        type: "paragraph",
        content:
          "Während dieses besonderen Events durchlief Metacube eine komplette Transformation und wurde in **Monkecube** umbenannt. Dies war nicht nur eine kleine kosmetische Änderung – es war ein vollständiges Rebranding des Spielerlebnisses.",
      },
      ...
      { type: "heading", content: "Event-Belohnungen" },
      {
        type: "paragraph",
        content:
          "Teilnehmer am Monkecube-Event konkurrierten um **STRK-Token**, die basierend auf der Event-Rangliste vergeben wurden. Die Rangliste verfolgte die Anzahl der zerstörten Würfel, gesammelten Münzen und wendete Strafen für Spielertode an.",
      },
      ...
      { type: "heading", content: "Community-Reaktionen" },
      {
        type: "paragraph",
        content:
          "Das Monkecube-Event wurde schnell zu einem Fan-Favoriten, wobei die Community die unerwartete urzeitliche Transformation annahm. Die unbeschwerte Natur von Monkecube bot eine erfrischende Abwechslung zum üblichen Metacube-Erlebnis.",
      },

      {
        type: "paragraph",
        content:
          "Haben Sie am Monkecube-Event teilgenommen? Teilen Sie Ihre Erinnerungen in unserem Discord-Kanal oder in den Kommentaren unten!",
      },
    ],
  ...
  "crypto-rave-pulse-event": {
    ...
    excerpt:
      "Erleben Sie das Crypto Rave Pulse Event, bei dem Pelton Flusk massive Soundsysteme und Rave-Musik einsetzte, um die elektrische Verteidigung des Metacube zu neutralisieren.",
    content: [
      { type: "heading", content: "Sound gegen elektrische Verteidigung" },
      {
        type: "paragraph",
        content:
          "Der Crypto Rave Pulse war ein bahnbrechendes Event im Metacube-Universum. Während dieser Zeit setzte Pelton Flusk riesige Lautsprecher rund um den Metacube-Perimeter ein, die kraftvolle Rave-Musik ausstrahlten, die speziell kalibriert war, um die elektrischen Verteidigungssysteme des Würfels zu neutralisieren.",
      },
      ...
      { type: "heading", content: "Gameplay-Auswirkungen" },
      {
        type: "paragraph",
        content:
          "Normalerweise fügen die Verteidigungen des Metacube Schaden zu, wenn Spieler mit ihnen interagieren, obwohl sie Bewegungen nicht verhindern. Während des Crypto Rave Pulse Events wurden diese Verteidigungen durch die Musik neutralisiert, was es Spielern ermöglichte, ohne Schaden durch die Verteidigungsmechanismen des Würfels zu navigieren.",
      },
      ...
      { type: "heading", content: "Event-Soundtrack" },
      {
        type: "paragraph",
        content:
          "Der komplette Crypto Rave Pulse Soundtrack, komponiert von Pelton Flusk selbst, ist auf SoundCloud verfügbar. Sie können alle Tracks dieses besonderen Events anhören unter: [Crypto Rave Pulse by Pelton Flusk](https://soundcloud.com/metacubegames/sets/crypto-rave-pulse-by-pelton-flusk).",
      },
      ...
      { type: "heading", content: "Event-Belohnungen" },
      {
        type: "paragraph",
        content:
          "Spieler, die am Crypto Rave Pulse Event teilnahmen, konkurrierten um **STRK-Token** basierend auf ihrer Ranglisten-Position. Das Ranglisten-Ranking wurde aus der Anzahl der zerstörten Würfel und gesammelten Münzen berechnet, wobei Strafen für Todesfälle während des Events angewendet wurden.",
      },

      {
        type: "paragraph",
        content:
          "Der Crypto Rave Pulse demonstrierte, wie sich Metacube kontinuierlich durch kreative, zeitlich begrenzte Events entwickelt, die sowohl Unterhaltung als auch wertvolle Belohnungen bieten.",
      },
    ],
  ...
  "metacube-gameplay-guide": {
    ...
    title:
      "Entdecken Sie das Metacube-Universum: Vollständiger Gameplay-Leitfaden",
    date: "2025-05-07",
    author: "The Metacube Team",
    imageUrl: "/blog/metacube_g.jpg",
    excerpt:
      "Tauchen Sie ein in Metacubes spannende Gameplay-Mechaniken, lernen Sie die mysteriöse Metacube-Struktur kennen, die In-Game-Währung und überwinden Sie herausfordernde Gefahren in diesem umfassenden Leitfaden.",
    content: [
      { type: "heading", content: "Einführung in Metacube" },
      {
        type: "paragraph",
        content:
          "Metacube ist ein revolutionäres Free-to-Play NFT-Spiel, das die Aufregung der Schatzsuche, die Faszination der Blockchain-Technologie und den Nervenkitzel der interstellaren Erkundung kombiniert. In diesem immersiven Spielerlebnis übernehmen Spieler die Rolle von Stove dem Crypto Raver, einem eingefleischten Fan von Kryptowährungen und regelmäßigem Besucher interstellarer Raves. Gemeinsam mit anderen Stellar Scavengers begeben sich Spieler auf eine waghalsige Mission, um die Geheimnisse des Metacube zu entschlüsseln, eines himmlischen Tresors mit wertvollen Blockchain-Daten und seltenen NFTs.",
      },
      {
        type: "paragraph",
        content:
          "Dieser umfassende Leitfaden führt Sie durch die Kern-Gameplay-Elemente, hilft Ihnen, die mysteriöse Metacube-Struktur zu verstehen, erklärt das In-Game-Währungssystem und bereitet Sie auf die verschiedenen Gefahren und Herausforderungen vor, denen Sie auf Ihrer Reise begegnen werden.",
      },
      ...
      { type: "heading", content: "Gefahren und Herausforderungen" },
      {
        type: "paragraph",
        content:
          "Um ein fesselndes und dynamisches Spielerlebnis zu schaffen, müssen Spieler während ihres Abenteuers eine Vielzahl von Gefahren und Herausforderungen überwinden:",
      },
      {
        type: "paragraph",
        content:
          "• **Würfel-Gegenangriffe**: Einige Würfel besitzen starke Verteidigungen und werden sich wehren, wenn sie unsachgemäß getroffen werden, wobei sie Stove und seine Mining-Rig-Waffe beschädigen.\n• **Steuerprüfer**: Bestimmte Würfel entfesseln, wenn sie zerstört werden, unermüdliche Steuerprüfer, die Spieler jagen und belästigen. Wenn die Gesundheit eines Spielers null erreicht, werden sie vorübergehend aus dem Spiel ausgesperrt, was ein Gefühl von Dringlichkeit und Risiko schafft.\n• **Umweltgefahren**: Die Oberfläche von Zerith-9 stellt einzigartige Herausforderungen dar, einschließlich des Potenzials für Fallschaden aus großen Höhen und des Risikos, während der Erkundung des Weltraum-Vakuums keinen Sauerstoff mehr zu haben.\n• **Zeitdruck**: Während die Stellar Scavengers gegen die Zeit antreten, um die Geheimnisse des Metacube zu entschlüsseln, müssen Spieler ihre Strategien optimieren und kalkulierte Entscheidungen treffen, um der Konkurrenz voraus zu sein.",
      },
      {
        type: "paragraph",
        content:
          "Durch das Überwinden dieser Herausforderungen machen Spieler Fortschritte im Spiel und erwerben wertvolle Blockchain-Daten und NFTs, die letztendlich ihren Erfolg in Metacube bestimmen werden.",
      },

      {
        type: "heading",
        content: "Erkunden Sie das komplette Metacube-Universum",
      },
      {
        type: "paragraph",
        content:
          "Dieser Leitfaden bietet nur einen Einblick in die weite und aufregende Welt von Metacube. Um tiefer in die Spielmechanik, NFT-Sammlungen und zukünftigen Entwicklungspläne einzutauchen, laden wir Sie ein, unser [offizielles Metacube-Whitepaper](https://metacube-1.gitbook.io/metacube-games) zu lesen.",
      },
      {
        type: "paragraph",
        content: "Das Whitepaper enthält umfangreiche Informationen über:",
      },
      {
        type: "paragraph",
        content:
          "• Detaillierte Spielmechanik und Strategien\n• Vollständige Aufschlüsselung der NFT-Sammlerstücke und ihrer Seltenheit\n• Den NFT-Marktplatz und das Handelssystem\n• In-Game-Nutzen verschiedener digitaler Assets\n• Zukünftige Entwicklungs-Roadmap einschließlich Season 2 und darüber hinaus\n• Team hinter der Entwicklung von Metacube",
      },
      {
        type: "paragraph",
        content:
          "Egal ob Sie ein neuer Spieler sind, der loslegen möchte, oder ein erfahrener Stellar Scavenger, der nach fortgeschrittenen Strategien sucht, das Whitepaper bietet wertvolle Einblicke zur Verbesserung Ihres Metacube-Erlebnisses.",
      },
    ],
  ...
  "welcome-to-our-new-blog": {
    ...
    excerpt:
      "Wir freuen uns, unseren neuen Blog zu starten! Entdecken Sie Updates, Leitfäden, Community-Highlights und Einblicke in die Welt von Metacube.",
    content: [
      { type: "heading", content: "Ein neuer Knotenpunkt für Metacube-News" },
      {
        type: "paragraph",
        content:
          "Willkommen, Metacuber! Wir freuen uns sehr, den **Metacube-Blog** offiziell zu starten, Ihren neuen zentralen Knotenpunkt für alles rund um unser sich ständig erweiterndes Universum. Hier finden Sie die neuesten Nachrichten, Entwicklungs-Updates, ausführliche Spiel-Leitfäden, Community-Spotlights und vieles mehr.",
      },
      {
        type: "paragraph",
        content:
          "Unser Ziel ist es, Ihnen eine direkte Verbindung zum Team zu bieten und einen Ort zum Erkunden der Tiefen von Metacube zu schaffen. Egal ob Sie ein *erfahrener Spieler* sind oder gerade Ihre Reise beginnen, wir hoffen, dass dieser Blog zu einer wertvollen Ressource für Sie wird.",
      },
      { type: "heading", content: "Was Sie erwarten können" },
      {
        type: "paragraph",
        content:
          "• **Neueste Ankündigungen:** Seien Sie der Erste, der von neuen Features, bevorstehenden Events und wichtigen Updates erfährt.\n• **Entwickler-Einblicke:** Werfen Sie einen Blick hinter die Kulissen unseres Entwicklungsprozesses, Herausforderungen und zukünftigen Pläne.\n• **Spiel-Leitfäden & Tipps:** Meistern Sie Metacube mit detaillierten Leitfäden, Strategien und Tipps sowohl vom Team als auch von erfahrenen Spielern.\n• **Community-Highlights:** Wir werden erstaunliche Kreationen, Spielergeschichten und von der Community veranstaltete Events präsentieren. Teilen Sie Ihre Inhalte mit uns!\n• **Lore & Story:** Tauchen Sie tiefer in die Welt von Metacube und ihre reiche Erzählung ein.",
      },
      {
        type: "paragraph",
        content:
          "Wir freuen uns darauf, dieses neue Kapitel mit Ihnen zu beginnen. Bleiben Sie dran für regelmäßige Updates und zögern Sie nicht, Ihr Feedback und Ihre Vorschläge in unseren Community-Kanälen zu teilen!",
      },
    ],
  ...
  "introducing-community-streams": {
    ...
    title:
      "Vorstellung der Community-Streams: Teilen Sie Ihre Metacube-Momente!",
    date: "2025-05-07",
    author: "The Metacube Team",
    imageUrl: "/blog/community_b.jpg",
    excerpt:
      "Entdecken Sie unseren neuen Community-Streams-Bereich! Schauen Sie Live-Gameplay zu, teilen Sie Ihre eigenen Streams und verbinden Sie sich mit anderen Metacubern.",
    content: [
      { type: "heading", content: "Rücken Sie Ihr Gameplay ins Rampenlicht" },
      {
        type: "paragraph",
        content:
          "Wir freuen uns unglaublich, den Start unseres brandneuen **Community-Streams**-Bereichs auf der Metacube-Website bekannt zu geben! Dies ist Ihr dedizierter Raum, um Live-Gameplay von anderen Metacubern zu entdecken und, noch wichtiger, Ihre eigenen Metacube-Abenteuer mit der Welt zu teilen.",
      },
      {
        type: "paragraph",
        content:
          "Egal ob Sie ein erfahrener Streamer sind oder einfach nur einen coolen Moment teilen möchten, unsere Community-Streams-Seite macht es einfach. Sie können Links zu Ihren Live-Streams oder VODs von beliebten Plattformen wie [YouTube](https://youtube.com), [Twitch](https://twitch.tv) und [Kick](https://kick.com) einreichen.",
      },
      { type: "heading", content: "Was Sie finden werden" },
      {
        type: "paragraph",
        content:
          "• **Featured Live-Streams:** Wir werden laufende Live-Streams direkt auf der Seite hervorheben, um es einfach zu machen, in die Action einzutauchen.\n• **Community-Video-Raster:** Durchsuchen Sie eine Sammlung von Videos und vergangenen Streams, die von Spielern eingereicht wurden. Entdecken Sie neue Strategien, beeindruckende Builds oder genießen Sie einfach, anderen beim Erkunden von Metacube zuzusehen.\n• **Einfache Einreichung:** Ein einfaches Formular ermöglicht es Ihnen, Ihren Video- oder Stream-Link einzureichen, eine Beschreibung hinzuzufügen und sogar die Sprache Ihres Inhalts anzugeben.",
      },
      {
        type: "paragraph",
        content:
          "Das Ziel ist es, einen lebendigen und interaktiven Raum zu schaffen, in dem Spieler sich verbinden, voneinander lernen und die vielfältigen Arten präsentieren können, wie Metacube erlebt wird. Wir können es kaum erwarten, Ihre Inhalte zu sehen!",
      },
      {
        type: "paragraph",
        content:
          "Gehen Sie jetzt zur Community-Streams-Seite, um sie sich anzusehen und Ihren ersten Stream oder Ihr erstes Video einzureichen!",
      },
    ],
    relatedPosts: ["welcome-to-our-new-blog", "nft-collectibles-guide"],
  },
  "nft-collectibles-guide": {
    ...
    excerpt:
      "Entschlüsseln Sie die Geheimnisse der NFT-Sammlerstücke in Metacube. Dieser Leitfaden deckt Seltenheit, Eigenschaften und wie Sie das Beste aus Ihren digitalen Assets herausholen.",
    content: [
      { type: "heading", content: "Seltenheitsstufen verstehen" },
      {
        type: "paragraph",
        content:
          "In Metacube gibt es NFT-Sammlerstücke in verschiedenen Seltenheitsstufen, die jeweils ihre Einzigartigkeit und ihren potenziellen Wert beeinflussen. Diese Stufen sind typischerweise: **Common, Rare, Epic, Mythic und Legendary**. Je seltener das Item, desto ausgeprägter sind seine Attribute und sein Erscheinungsbild.",
      },
      {
        type: "paragraph",
        content:
      ...
      },
      {
        ...
        alt: "NFT Seltenheits-Verteilungsdiagramm",
      },
      {
        type: "paragraph",
        content:
          "Die Verteilung dieser Seltenheiten wird sorgfältig verwaltet, um ein ausgewogenes und fesselndes Sammelerlebnis zu gewährleisten.",
      },
      { type: "heading", content: "Schlüssel-Eigenschaften und Attribute" },
      {
        type: "paragraph",
        content:
          "Jedes NFT-Sammlerstück besitzt eine Reihe von Eigenschaften, die seine Charakteristika definieren. Diese können von visuellen Elementen wie *Farbe* und *Design* bis hin zu funktionalen Attributen reichen, die das Gameplay oder den Nutzen innerhalb des Metacube-Ökosystems beeinflussen könnten.",
      },
      {
        type: "paragraph",
        content:
          "Das Verständnis dieser Eigenschaften ist entscheidend für die Bewertung des Wertes und Potenzials eines NFT. Sammler suchen oft nach Items mit seltenen Eigenschaftskombinationen oder solchen, die ihren Spielstil ergänzen.",
      },
    ],
  ...
  "starknet-transactions-batcher": {
    ...
    excerpt:
      "Erfahren Sie mehr über den Transaktions-Batcher, der in Metacube verwendet wird, um NFTs, die von Spielern verdient wurden, sofort zu senden, mit einer detaillierten Implementierung in Go.",
    content: [
      ...
      },
      {
        type: "paragraph",
        content:
          "Dieser Beitrag basiert auf dem Artikel, der ursprünglich auf [dev.to](https://dev.to/bastienfaivre/a-starknet-transactions-batcher-1hpk) von Bastien Faivre veröffentlicht wurde.",
      },
      { type: "heading", content: "Architektur" },
      {
        type: "paragraph",
        content: "Der Batcher besteht aus zwei Hauptakteuren:",
      },
      {
        type: "paragraph",
        content:
      ...
      },
      {
        ...
        alt: "Starknet Batcher Architektur",
      },
      ...
      { type: "heading", content: "Builder" },
      {
        type: "paragraph",
        content:
          "Analysieren wir den Build-Akteur. Beachten Sie, dass der Code zur besseren Lesbarkeit vereinfacht wurde (vollständiger Code verfügbar auf [GitHub](https://github.com/metacube-games/starknet-batcher/)).",
      },
      {
        type: "code",
        language: "go",
      ...
      { type: "heading", content: "Sender" },
      {
        type: "paragraph",
        content:
          "Analysieren wir nun den Sender-Akteur. Beachten Sie, dass der Code zur besseren Lesbarkeit vereinfacht wurde (vollständiger Code verfügbar auf [GitHub](https://github.com/metacube-games/starknet-batcher/)).",
      },
      {
        type: "code",
        language: "go",
      ...
      },
      {
        type: "paragraph",
        content:
          "Für weitere Informationen schauen Sie sich den [Originalartikel auf dev.to](https://dev.to/bastienfaivre/a-starknet-transactions-batcher-1hpk) und das [GitHub-Repository](https://github.com/metacube-games/starknet-batcher) an.",
      },
    ],
  ...
  "starknet-signatures-guide": {
    ...
    excerpt:
      "Lernen Sie den Prozess des Signierens und Verifizierens von Signaturen auf Starknet kennen, mit Code-Beispielen in TypeScript und Go.",
    content: [
      { type: "heading", content: "Zusammenfassung" },
      {
        type: "paragraph",
      ...
      },
      {
        type: "paragraph",
        content:
          "Dieser Beitrag basiert auf dem Artikel, der ursprünglich auf [dev.to](https://dev.to/bastienfaivre/a-guide-on-starknet-signatures-a3m) von Bastien Faivre veröffentlicht wurde.",
      },
      ...
      {
        type: "heading",
        content: "Eine Signatur mit dem öffentlichen Schlüssel verifizieren",
      },
      {
        type: "paragraph",
        content:
      ...
      {
        type: "heading",
        content: "Eine Signatur mit der Kontoadresse verifizieren",
      },
      {
        type: "paragraph",
        content:
      ...
      {
        type: "heading",
        content: "Arbeiten mit einer Wallet (Ready Wallet, Braavos, etc.)",
      },
      {
        type: "paragraph",
        content:
      ...
      },
      {
        type: "paragraph",
        content:
          "Für weitere Informationen schauen Sie sich den [Originalartikel auf dev.to](https://dev.to/bastienfaivre/a-guide-on-starknet-signatures-a3m) von Bastien Faivre an.",
      },
    ],
